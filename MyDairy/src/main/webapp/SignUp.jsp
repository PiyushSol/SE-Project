	...
	<main>
		...
		<div class="container">
			<div class="row">
					...
					<div id="carouselExampleSlidesOnly" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								<img class="d-block" src="Images/sky1.jpg" alt="Sky2">
							</div>
							<div class="carousel-item">
								<img class="d-block " src="Images/sky2.jpg" alt="Sky3">
							</div>
						</div>
					</div>
				</div>
				<div class="col-6 visual">
					<h2>
						Create your Account <img alt="account" src="Images/follow.png"
					...
					<form id="register" action="Signup" method="post"
						...
						<div class="row ">
							<div class="col">
							<img alt="refresh" src="Images/refresh.gif" style="width:40px ; height:40px; display:none;" id="spinner">
