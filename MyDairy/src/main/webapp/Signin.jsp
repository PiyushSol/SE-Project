...
<%@ page import="com.mydiary.helpers.Message" %>
...
<body>
			...
			<div class="row">
				<div class="col styles1">
					<h1 class="intro display-4">
						<img class="img-fluid" alt="notes" src="Images/post-it.png"
				...
				if(m!=null){
				 %>
						<div class="alert <%= m.getCssClass() %> text-center" style="font-style:klavika;" role="alert">
						<%= m.getContent() %>
						</div>				
				<%
	...
	<footer>
		...
		<img class="img-fluid" alt="github" src="Images/github.png"
			style="width: 18px; height: 18px;"><br> Twitter :<a
			href="https://twitter.com/piyush_sol">https://twitter.com/piyush_sol</a>
		<img class="img-fluid" alt="twitter" src="Images/twitter.png"
			style="width: 18px; height: 18px;"><br> Written By: Piyush
		Solanki <img alt="copyright" class="img-fluid" src="Images/copyright.png"
